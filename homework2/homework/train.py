...
def train(
    ...
    **kwargs,
    ...
    train_data = load_data("homework/classification_data/train", shuffle=True, batch_size=batch_size, num_workers=2)
    val_data = load_data("homework/classification_data/val", shuffle=False)
